...
export default function RespawnRestore() {
  return (
    <section id="respawn-restore" className="px-4 py-16 relative overflow-hidden">
      {/* Enhanced background gradient effect */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(0,224,255,0.05)_0%,_transparent_70%)] pointer-events-none"></div>
      ...
      <div className="vultisig-container max-w-4xl mx-auto relative z-10">
        ...
        <div className="p-[1px] rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600">
          <div className="bg-[#0a122a]/80 backdrop-blur-sm p-8 rounded-2xl">
