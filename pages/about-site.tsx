...
export default function AboutSitePage() {
  return (
    <main className="prose prose-invert lg:prose-xl max-w-3xl mx-auto px-6 py-16 font-sans">
      ...
      <div className="flex flex-col items-center justify-center py-12 mb-12 border-b border-gray-800">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-center text-transparent bg-clip-text bg-text-gradient mt-4">
  ...
  user-select: none;
      ...
      <p className="text-lg text-gray-300 leading-relaxed mb-4">As the contest closes, I'm:</p>
      <ul className="list-disc pl-6 my-6 space-y-3 text-gray-300">
